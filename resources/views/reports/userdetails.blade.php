        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <h5 class="card-title">User Details</h5>
              ...
              <div class="col-sm-3">
              <A href="{{url('userdetails_export')}}" target="_block"><button type="button" class="btn btn-danger rounded-pill" >Download As Pdf</button></A>
</div>
</div><br>
...
@if(Session::get('user_type_id') ==1)
                ...
                @foreach($superadmins as $dt)
                  ...
                  @endforeach
                  @endif
                  @if(Session::get('user_type_id') ==3 || Session::get('user_type_id') ==2)
                  @if($employee != false)
