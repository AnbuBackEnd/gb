            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Re Create Password</h5>
                   
                  </div>

                  <form method="post" action="{{ route('recreatepassword-post')}}" autocomplete="off">
                    @csrf
                  @if(Session::has('success'))
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="reenterpassword" class="form-control" id="reenterpassword">
