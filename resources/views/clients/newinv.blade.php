            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                  ...
                  @csrf
                    ...
                    <div class="col-sm-8">
                      <input type="text" list="browsers" class="form-control" name="clientcode" id="clientcode" autocomplete="off">
                    
                      <datalist id="browsers">
                        @foreach($clients as $row)
                        <option value="<?php echo $row['client_code']; ?>"><?php echo $row['client_name']; ?></option>
                          @endforeach
