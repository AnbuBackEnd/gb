...
<body>
        ...
        <div class="col-lg-9">
          <div class="card">
            <div class="card-body">
              ...
              <?php $investamount=$row['invest_amount']; ?>
              <?php $investdate=date('d-m-Y',strtotime($row['invest_date'])); ?>
            ...
            <div class="row mb-3">
                ...
                <label class="col-form-label">Investment Date</label>
                  ...
                  <div class="col-sm-8">
                  <input type="date" class="form-control" name="investdate" id="investdate" value="{{ old('investdate') }}">
  ...
  $(document).ready(function(){
   $('#investamount').val('<?php echo $investamount; ?>');
   $('#investdate').val('<?php echo $investdate; ?>');
